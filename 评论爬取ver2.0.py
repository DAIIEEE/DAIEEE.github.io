...
def Out2File(dict):
    ...
    '''
    with open('BiliBiliComments_modify.txt', 'a+', encoding='utf-8') as f:
        i = 0
        for comment in dict:
            i = i + 1
            try:
                f.write('姓名：{}, 点赞数：{}, 评论内容：{}, 评论时间：{}'.format(
...
if __name__ == '__main__':
    ...
    page = 1
    while e == 0:
        url = "https://api.bilibili.com/x/v2/reply?pn=" + str(page) + "&type=1&oid=759395091&sort=2"
        try:
            print()
